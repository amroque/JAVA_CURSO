...
* 
* 
• Si el monto supera los 3000 pesos: Informar que posee un descuento del
10%. Especificar cuánto sería el nuevo monto total con descuento.
 */
public class Merceria_ant {
    ...
    public static void main(String[] args) {
        ...
        if (monto<1000) {
            ...
            monto*=0.95;
            System.out.println("Usted tiene como promoción un descuento del 5%. Solo tendrá que pagar " + monto);
        }else{
            monto*=0.90;
            System.out.println("Usted tiene como promoción un descuento del 10%. Solo tendrá que pagar " + monto);
